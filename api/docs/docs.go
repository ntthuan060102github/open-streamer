...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "config.SessionsConfig": {
            ...
            "properties": {
                "enabled": {
                    "description": "Enabled toggles the entire feature. When false, the tracker no-ops and\nthe API endpoints return empty.",
                    "type": "boolean"
                },
                "geoip_db_path": {
                ...
                "idle_timeout_sec": {
                    "description": "IdleTimeoutSec is how long a session may go without activity before the\nreaper closes it. Default 30 s when \u003c= 0.",
                    "type": "integer"
                },
                "max_lifetime_sec": {
                    "description": "MaxLifetimeSec, when \u003e 0, hard-closes any session older than this even\nif it's still seeing activity. 0 disables the cap.",
                    "type": "integer"
                }
            }
        },
        ...
        "domain.EventType": {
            ...
            "x-enum-comments": {
                ...
                "EventInputFailover": "switched to a different input",
                "EventInputReconnecting": "transient error, retrying",
                "EventInputRecovered": "previously degraded input is healthy again (auto or via failback probe)",
                "EventPushActive": "handshake ok; media flowing",
                "EventPushFailed": "dest.Limit exhausted or terminal error",
                "EventPushReconnecting": "write fail or input discontinuity, retrying",
                "EventPushStarted": "dialing target, pre-handshake",
            ...
            "x-enum-descriptions": [
                ...
                "switched to a different input",
                "previously degraded input is healthy again (auto or via failback probe)",
                "",
                "",
                "",
                "",
                "retention loop deleted an aged-out segment",
                "",
                "",
                "",
                "dialing target, pre-handshake",
                "handshake ok; media flowing",
                "write fail or input discontinuity, retrying",
                "dest.Limit exhausted or terminal error",
                "",
                "",
                "",
                "",
            ...
            "x-enum-varnames": [
                ...
                "EventSegmentWritten",
                "EventDVRSegmentPruned",
                "EventTranscoderStarted",
                "EventTranscoderStopped",
                "EventTranscoderError",
                "EventPushStarted",
                "EventPushActive",
                "EventPushReconnecting",
                "EventPushFailed",
                "EventConfigChanged",
                "EventWatermarkAssetCreated",
        ...
        "domain.Hook": {
            ...
            "properties": {
                ...
                "timeout_sec": {
                    "description": "TimeoutSec is the per-attempt delivery timeout in seconds.\n0 means use the server default (10s).",
                    "type": "integer"
                },
                "type": {
        ...
        "domain.Input": {
            ...
            "properties": {
                "headers": {
                    "description": "Headers are arbitrary HTTP headers sent with every request for HTTP/HLS inputs.\nCommon uses:\n  \"Authorization\": \"Bearer \u003ctoken\u003e\"\n  \"Authorization\": \"Basic \u003cbase64(user:pass)\u003e\"\n  \"X-Custom-Token\": \"secret\"",
                    "type": "object",
                    "additionalProperties": {
                        "type": "string"
                    }
                ...
                "url": {
                    "description": "URL is the source endpoint. See the package doc for supported formats.",
                    "type": "string"
                }
            }
        },
        ...
        "domain.OutputProtocols": {
            ...
            "properties": {
                "dash": {
                    "description": "DASH enables MPEG-DASH packaging over HTTP.\nRequired for Widevine/PlayReady DRM.",
                    "type": "boolean"
                },
                "hls": {
        ...
        "domain.PlaySession": {
            ...
            "properties": {
                ...
                "country": {
                    "description": "Country is an ISO 3166-1 alpha-2 country code from the configured\nGeoIP resolver, or \"\" when GeoIP is disabled / lookup failed.",
                    "type": "string"
                },
                "dvr": {
                ...
                "opened_at": {
                    "description": "OpenedAt is the time the first activity for this session was observed.",
                    "type": "string"
                },
                "proto": {
                ...
                "query_string": {
                    "description": "QueryString is the raw query of the FIRST request that opened the\nsession (HLS/DASH) — useful when token/abr-variant info is encoded there.",
                    "type": "string"
                },
                "referer": {
                ...
                "secure": {
                    "description": "Secure is true when the underlying transport was TLS / SRTS / RTMPS.",
                    "type": "boolean"
                },
                "started_at": {
                    "description": "StartedAt is when the first byte of media was delivered (segment data\nfor HLS/DASH, first frame after RTMP play handshake). Zero before\nmedia flows.",
                    "type": "string"
                },
                "stream_code": {
                ...
                "token": {
                    "description": "Token is the value of ` + "`" + `?token=` + "`" + ` from the first request, when present.\nWhen set, NamedBy is SessionNamedByToken.",
                    "type": "string"
                },
                "updated_at": {
                    "description": "UpdatedAt is the time of the most recent activity. Idle reaper closes\nsessions whose UpdatedAt is older than (now - idle_timeout).",
                    "type": "string"
                },
                "user_agent": {
                    "description": "UserAgent is the browser/player User-Agent (HTTP) or the equivalent\nflashVer field for RTMP. May be empty.",
                    "type": "string"
                },
                "user_name": {
                    "description": "UserName is a human label. Resolved from token claims if available,\notherwise the fingerprint hash short form. Empty when no identity could\nbe resolved.",
                    "type": "string"
                }
            }
        },
        "domain.PushDestination": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "Status is a runtime-only field updated by the publisher.\nNot persisted to storage.",
                    "allOf": [
                        {
        ...
        "domain.ThumbnailConfig": {
            ...
            "properties": {
                ...
                "output_dir": {
                    "description": "OutputDir is relative to the publisher HLS directory.\nE.g. \"thumbnails\" → written to {hls_dir}/{stream_code}/thumbnails/thumb.jpg",
                    "type": "string"
                },
                "quality": {
                    "description": "Quality is the JPEG quality (1–31, lower = better). Default: 5.",
                    "type": "integer"
                },
                "width": {
                    "description": "Width and Height of the output thumbnail in pixels.\n0 = match source resolution.",
                    "type": "integer"
                }
            }
        },
        ...
        "domain.VideoProfile": {
            ...
            "properties": {
                ...
                "keyframe_interval": {
                    "description": "KeyframeInterval is the GOP size in seconds.\nMust match or be a multiple of the HLS/DASH segment duration.",
                    "type": "integer"
                },
                "level": {
                    "description": "Level controls the H.264/H.265 encoding level.\nCommon: \"3.1\", \"4.0\", \"4.1\", \"4.2\", \"5.0\", \"5.1\"",
                    "type": "string"
                },
                "max_bitrate": {
                    "description": "MaxBitrate caps the peak bitrate in kbps (CBR/VBR ceiling). 0 = no cap.",
                    "type": "integer"
                },
                "preset": {
                    "description": "Preset controls the encoder speed/quality tradeoff.\nlibx264: \"ultrafast\" | \"superfast\" | \"veryfast\" | \"faster\" | \"fast\" | \"medium\" | \"slow\" | \"veryslow\"\nNVENC:   \"p1\" (fastest) .. \"p7\" (highest quality)",
                    "type": "string"
                },
                "profile": {
                    "description": "Profile controls the H.264/H.265 encoding profile.\n\"baseline\" | \"main\" | \"high\" (H.264); \"main\" | \"main10\" (H.265)",
                    "type": "string"
                },
                "refs": {
                    "description": "Refs is the number of reference frames. nil = encoder default.\nHigher = better compression at cost of CPU/latency. NVENC has its own caps.",
                    "type": "integer"
                },
                "resize_mode": {
                    "description": "ResizeMode chooses how the source is fitted to Width/Height.\n\"\" defaults to ResizeModePad.",
                    "allOf": [
                        {
                ...
                "sar": {
                    "description": "SAR is the output Sample Aspect Ratio, \"N:M\". \"\" = inherit from source.\nUse \"1:1\" for square pixels (web); \"16:11\", \"59:54\" etc. for anamorphic.",
                    "type": "string"
                },
                "width": {
                    "description": "Width and Height define the output resolution.\nSet to 0 to keep the source dimensions (Width=0 \u0026 Height=0 = no scaling).",
                    "type": "integer"
                }
            }
        },
        ...
        "domain.WatermarkConfig": {
            ...
            "properties": {
                ...
                "font_file": {
                    "description": "FontFile is the path to a .ttf/.otf font file.\n\"\" = FFmpeg default font.",
                    "type": "string"
                },
                "font_size": {
